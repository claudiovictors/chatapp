...
/*
 ...
 |--------------------------------------------------------------------------
 |
 | Gerencia o tratamento de erros e exceções, fornecendo métodos
 | para manipular e renderizar páginas de erro.
 |
 */
...
class ErrorHandler
{
    ...
    public function handleException(\Throwable $exception): void
    {
        ...
        $errorData = $this->getErrorData($exception, $isDebug);
     ...
     * @return void
     */
    public function handleEnvError(\Exception $exception): void
    {
        $response = new Response();
    ...
    /**
     * Coleta dados detalhados do erro para depuração.
     *
     * @param \Throwable $exception
     * @param bool $isDebug
     * @return array
     */
    private function getErrorData(\Throwable $exception, bool $isDebug): array
    {
        if (!$isDebug) {
            return [
        ...
        return [
            ...
            'file' => $exception->getFile(),
            'line' => $exception->getLine(),
            'code' => $this->getCodeSnippet($exception->getFile(), $exception->getLine()),
